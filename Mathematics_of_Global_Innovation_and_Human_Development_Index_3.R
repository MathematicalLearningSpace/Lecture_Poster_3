...
#----------------------------------Transformations-------------------------------------------------------
Nutrition.df<-Nutrition.df[with(Nutrition.df, 
                                      order(Nutrition.df$Vit_A_IU,
                                            decreasing=TRUE)),]
Nutrition.Beans.Protein.df<-Nutrition.Beans.df[with(Nutrition.Beans.df, 
                                                    order(Nutrition.Beans.df$`Protein_(g)`,
                                                  decreasing=TRUE)),]
Nutrition.Protein.df<-Nutrition.df[with(Nutrition.df, 
                                              order(Nutrition.df$`Protein_(g)`,
                                                    decreasing=TRUE)),]
