%---------------Example Recipe Design for the Classroom Break for Lunch with Students---------------------------%
%--------------------------------------------------------------------------------------------------------%
\documentclass{recipecard}
\begin{document}
\vspace{8pt}
%-------Vector of Features, Categories and Parameters for the Recipe------------------------------------------
\ingredient{1/2 cup chopped white onion}
\ingredient{1 cup  5 cheeses: Provolone, Romano, Mozzarela, Asiago, Parmesan} % Optional
...
%-----------------------Keywords for Recipes steps in Algorithm 1----------------------------------------
...
\bibtem[1]{key1}Joy Alkema and Spencer L. Seager 1982
\newblock The Chemical Pigments of Plants 
\newblock Chem I Supplement

\bibitem[2]{key1000}, K. I., Epstein, J. B., Ettinger, D., Jatoi, A., McManus, K., Platek, M. E., … Moskowitz, B. (2015). 
