...
%-------------------------------------------------------------------------------------
\documentclass{ResumeDesignFormat2}
...
\stringBox{\Fontskrivan\slshape\{In this section based on course 1 in the Mathematical Learning Space these examples are representations of articles from the courses.  Here the 3500 words 3 page 2 column data structure in XML,HTML and TeX with 3 tables and a 3 x 3 matrix of figures is the design pattern for scientific communication.}}
...
\stringBox{\Fontskrivan\slshape\{Research Vision Statement goes here.}}
\begin{table}[ht]
\footnotesize
\centering
