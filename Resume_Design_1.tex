...
\stringBox{\Fontskrivan\slshape\{Daily work in mathematical oncology with a research portfolio of work provided on the mathematical learning space web site with the Github file server.}}
%-------------------------------------------------------------------------------------------%
%----------------------------------------Figure1--------------------------------------------% 
%-------------------------------------------------------------------------------------------%
\centering
